...
<div class="filtr_home">
<l>Поиск</l>
<form method="GET">
	<label for="number_home">Этажей</label>
	<input type="text" name="search_home"><br>
	<l>Тип стен</l><br>
	<input type="radio" name="search_home" value="Кирпич">Кирпич
	<input type="radio" name="search_home" value="Бетон">Бетон
	<input type="radio" name="search_home" value="Камень">Камень
	<input type="radio" name="search_home" value="Дерево">Дерево
	<input type="submit" name="send_search_home" value="Поиск">
</form>
</div>
...
echo  "	
	<div class=examples_rooms>
		<div class=examples_img>
			<img src=img/house/$out_home[picture_apartments]>
		</div>
		<div class=house_rooms>
			...
			<div class=look_rooms>
				<div class=btn-success>
					<div class=btn>
				        <a href=kvartiri.php?home_id=$id >Посмотреть квартиры</a>
				    </div>
				 </div>   
			</div>
		</div>
